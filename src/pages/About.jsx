      ...
      <div className="px-6 md:px-20 py-16 max-w-6xl mx-auto">
        ...
        <div className="mb-20">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-4xl font-bold text-yellow-600 dark:text-yellow-400 mb-6">
                Our Story
              </h2>
        ...
        <div className="mb-20">
          <h2 className="text-4xl font-bold text-yellow-600 dark:text-yellow-400 mb-12 text-center">
            Why Choose DK Salon
          </h2>
        ...
        <div className="mb-20 bg-gray-100 dark:bg-gray-900/50 p-8 md:p-12 rounded-lg">
          <h2 className="text-3xl font-bold text-yellow-600 dark:text-yellow-400 mb-8">
            Our Values
          </h2>
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center flex flex-col items-center">
              <div className="mb-3"><img src={quality} className=""/></div>
              <h3 className="text-xl font-bold mb-2 text-gray-900 dark:text-white">Quality</h3>
              <p className="text-gray-600 dark:text-gray-300">Excellence in every cut</p>
            </div>
            <div className="text-center flex flex-col items-center">
              ...
              <p className="text-gray-600 dark:text-gray-300">Building relationships daily</p>
            </div>
            <div className="text-center flex flex-col items-center">
              ...
              <p className="text-gray-600 dark:text-gray-300">Honest service always</p>
            </div>
          </div>
        </div>
